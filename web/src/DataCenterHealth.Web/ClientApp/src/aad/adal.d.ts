...
declare namespace AuthenticationContext {
    ...
    interface Options {
        ...
        /**
         * A value included in the request that is also returned in the token response. ADAL uses "state" parameter too, so your state will be appended to it and will be available as customState={your state}.
         * Format of state returned in the response will be: state={ADAL state}|customState={your state}
         */
        state?: string;
    }

    ...
    return (function e(t, n, r) {
        ...
        1: [function (require, module, exports) {
            ...
            var AuthenticationContext = (function () {
                 ...
                 *  @property {string} state A value included in the request that is also returned in the token response. ADAL uses "state" parameter too, so your state will be appended to it. Format of state returned in the response will be: state={ADAL state}|customState={your state}
                 */
                ...
                AuthenticationContext = function (config) {
                    ...
                    if (this.config.state) {
                        this.config.customState = this.config.state;
                ...
                AuthenticationContext.prototype.login = function () {
                    ...
                    if (this.config.customState) {
                        expectedState = expectedState + '|customState=' + this.config.customState;
                    }
                ...
                AuthenticationContext.prototype._getResourceFromState = function (state) {
                    if (state) {
                        ...
                        if (splitIndex > -1 && splitIndex + 1 < state.length) {
                            var stateSplits = state.split("|", 2);
                            var customStateRegex = /customState=/gi;
                            if (!stateSplits[1].match(customStateRegex)) {
                                return stateSplits[1];
                            }
                        }
                    }
                ...
                AuthenticationContext.prototype.handleWindowCallback = function (hash) {
                    ...
                    if (this.isCallback(hash)) {
                        ...
                        if (window.parent === window && !isPopup) {
                            ...
                            } else if (self.config.navigateToLoginRequestUrl) {
